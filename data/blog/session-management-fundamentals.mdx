...
1. [Introduction](#introduction)
    - [A simple session management flow](#a-simple-session-management-flow)
        ...
        - [The purpose of access tokens](#the-purpose-of-access-tokens)
        - [Session Expiry](#session-expiry)
2. [Access Tokens](#access-tokens)
    - [Reference Tokens](#reference-tokens)
        - [Authorization flow](#authorization-flow)
        - [Considerations while using reference tokens](#considerations-while-using-reference-tokens)
    - [Value Tokens](#value-tokens)
        - [Authorization flow](#authorization-flow)
        - [Considerations while using value tokens](#considerations-while-using-value-tokens)
